...
#define LOW 	0x0000006C
#define HIGH 	0x0000001B
...
void TIMER0A_Handler (void){
	if(TIMER0 -> TAILR == HIGH){
				TIMER0 -> TAILR = LOW; //Set interval load as LOW, defined above
	}else{
			TIMER0 -> TAILR =HIGH; //Set interval load as LOW, defined above
	}
